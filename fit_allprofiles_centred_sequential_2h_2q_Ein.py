...
if components == 'all':
    outfile     = 'fitresults_2h_2q_Ein_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+file_name
else:
    outfile     = 'fitresults_2h_2q_Ein_'+components+'_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+file_name
...
if qext == '':
    ...
    def log_likelihood_DS(data_model, R, ds, iCds):
        ...
        DS   = Delta_Sigma_Ein_2h(R,zmean,10**lM200,c200,alpha,cosmo_params=params,terms='1h+2h')
