...
python fit_allprofiles_centred_2h2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz_relaxed.fits -RIN 250 -ROUT 5000  -ncores 15 -nit 200 &
python fit_allprofiles_centred_2h2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz_relaxed.fits -RIN 250 -ROUT 5000  -ncores 15 -nit 200 &
python fit_allprofiles_centred_2h2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz_relaxed.fits -RIN 250 -ROUT 5000  -ncores 15 -nit 200 -ang reduced &
python fit_allprofiles_centred_2h2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz_relaxed.fits -RIN 250 -ROUT 5000  -ncores 15 -nit 200 -ang reduced &
wait
