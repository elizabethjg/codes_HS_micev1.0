...
folder     = args.folder
file_name = 'profile_'+args.samp+'.fits'  
angle      = args.angle
...
if components == 'all':
    outfile2     = 'fitresults_2h_2q_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+'profile_'+args.samp+'_mispar.fits'
else:
    outfile2     = 'fitresults_2h_2q_'+components+'_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+'profile_'+args.samp+'_mispar.fits'
