...
python fit_allprofiles_centred_sequential.py           -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 2000  -ncores 7 -nit 250 -ang reduced&
...
python fit_allprofiles_centred_sequential_2h_2q.py     -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 5000  -ncores 7 -nit 250 -ang reduced&
wait
