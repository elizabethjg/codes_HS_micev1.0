...
python fit_allprofiles_centred_sequential_2h.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential_2h.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential_2h.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 -ang reduced &
python fit_allprofiles_centred_sequential_2h.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 -ang reduced &
python fit_allprofiles_centred_sequential_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 -ang reduced &
python fit_allprofiles_centred_sequential_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 200 -ang reduced &
wait
