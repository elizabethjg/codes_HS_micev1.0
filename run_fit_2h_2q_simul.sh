...
python fit_allprofiles_centred_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Hz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 250 &
python fit_allprofiles_centred_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Hz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 250 &
python fit_allprofiles_centred_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Hz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 250 -ang reduced &
python fit_allprofiles_centred_2h_2q.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Hz.fits -RIN 250 -ROUT 5000  -ncores 10 -nit 250 -ang reduced &
wait
