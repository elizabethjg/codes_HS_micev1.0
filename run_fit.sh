...
python fit_allprofiles_centred_sequential.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz_relaxed.fits -RIN 250 -ROUT 2000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz_relaxed.fits -RIN 250 -ROUT 2000  -ncores 10 -nit 200 &
python fit_allprofiles_centred_sequential.py -folder ~/MICE/HS-lensing/profiles/ -file profile_LM_Lz_relaxed.fits -RIN 250 -ROUT 2000  -ncores 10 -nit 200 -ang reduced &
python fit_allprofiles_centred_sequential.py -folder ~/MICE/HS-lensing/profiles/ -file profile_HM_Lz_relaxed.fits -RIN 250 -ROUT 2000  -ncores 10 -nit 200 -ang reduced &
