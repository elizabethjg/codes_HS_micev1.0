...
if components == 'all':
    outfile     = 'fitresults_2h_2q_simul_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+file_name
else:
    outfile     = 'fitresults_2h_2q_simul_'+components+'_'+str(int(RIN))+'_'+str(int(ROUT))+ang+'_'+file_name
...
def log_probability(data_model, R, profiles, iCOV):
    ...
    if 12.5 < lM200 < 16.0 and 1 < c200 < 7 and 0.2 < q < 1.0 and 0.2 < q2h < 1.0:
